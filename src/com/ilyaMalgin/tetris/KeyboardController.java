...
public class KeyboardController extends KeyAdapter {
    ...
    final private int ESCAPE = 0, SPACE = 1, PAUSE = 2, W = 3, S = 4, A = 5, D = 6, HAS_PRESSED = 7;

    private boolean keys[] = new boolean[8];

    @Override
    public void keyPressed(KeyEvent e) {
        keys[HAS_PRESSED] = true;
    ...
    public void eventsHandled() {
        keys[HAS_PRESSED] = false;
    }

    public boolean hasUnhandledEvents() {
        return keys[HAS_PRESSED];
    }
}
